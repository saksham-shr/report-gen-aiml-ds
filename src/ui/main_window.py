"""
Complete main application window with sidebar navigation
"""

from PyQt5.QtWidgets import (
    QMainWindow, QWidget, QHBoxLayout, QVBoxLayout, QSplitter,
    QFrame, QLabel, QStatusBar, QMessageBox, QStackedWidget
)
...
class MainWindow(QMainWindow):
    ...
    def setup_content_area(self):
        ...
        self.forms_container = QStackedWidget()
    ...
    def initialize_forms(self):
        ...
        for form in self.forms.values():
            self.forms_container.addWidget(form)
    ...
    def show_form(self, index):
        ...
        if index in self.forms:
            ...
            self.forms_container.setCurrentWidget(self.current_form)
